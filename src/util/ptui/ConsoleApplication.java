...
public abstract class ConsoleApplication {
     ...
     *         {@link #setOnCommand(String, int, String, ConsoleHandler)
     *         setOnCommand}.
     *     </li>
     *     <li>
     ...
     * your <code>main</code> method:
     * <br><br>
     * <code>ConsoleApplication.launch(&nbsp;TipOverPTUI.class,&nbsp;args&nbsp;);
     * </code>
     *
     * @param ptuiClass the class object that refers to the class to
     *                  be instantiated
     ...
     *
     * @param console Where the UI should print output. It is recommended to
     *                save this object in a field in the subclass.
     * @throws Exception in case an overriding subclass's method does
     */
